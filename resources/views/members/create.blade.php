        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('members.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="member_code" class="form-label">Kode Anggota <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('member_code') is-invalid @enderror" 
                               id="member_code" name="member_code" value="{{ old('member_code') }}" required>
                        @error('member_code')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="join_date" class="form-label">Tanggal Daftar <span class="text-danger">*</span></label>
